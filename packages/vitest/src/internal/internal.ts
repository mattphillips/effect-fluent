...
const runPromise: <E, A>(_: Effect<A, E, never>, ctx?: V.TestContext | undefined) => Promise<A> = (effect, ctx) =>
  _Effect.fnUntraced(
    function* <E, A>(effect: _Effect.Effect<A, E>, _ctx?: Vitest.TestContext) {
      const exit = yield* _Effect.exit(effect);

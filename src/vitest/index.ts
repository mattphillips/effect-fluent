...
export namespace Vitest {
  ...
  export interface MethodsNonLive<R = never, ExcludeTestServices extends boolean = false> extends API {
    ...
    readonly flakyTest: <A, E, R2>(self: Effect<A, E, R2>, timeout?: Duration.DurationInput) => Effect<A, never, R2>;
 ...
 * @since 1.0.0
 */
export const flakyTest: <A, E, R>(self: Effect<A, E, R>, timeout?: Duration.DurationInput) => Effect<A, never, R> =
  internal.flakyTest;
